            ...
            <div className={styles.content}>
                    ...
                    <Card className={styles.section}>
                        ...
                        <ul className={styles.syllabus}>
                            <li>
                                ...
                                <span>Week 1: Soil Preparation & Seeds</span>
                            </li>
                            <li>
                                <CheckCircle size={16} className={styles.check} />
                                <span>Week 2: Watering & Nutrition</span>
                            </li>
                            <li>
                                <CheckCircle size={16} className={styles.check} />
                                <span>Week 3: Pest Management</span>
                            </li>
                            <li>
                                <CheckCircle size={16} className={styles.check} />
                                <span>Week 4: Harvesting Techniques</span>
                            </li>
                        </ul>
                    </Card>
                </div>
                ...
                <div className={styles.sidebar}>
                    <Card className={styles.enrollCard}>
                        ...
                        <Button className={styles.fullBtn} size="lg">Enroll Now</Button>
